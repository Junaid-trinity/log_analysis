...
class OpenAIClient:
    def __init__(self):
        ...
        self.config_loader = ConfigLoader(["DEFAULT_COMPLETIONS_MODEL", "DEFAULT_EMBEDDINGS_MODEL","OPENAI_API_KEY"])
        self.tokenizer = tiktoken.get_encoding("cl100k_base")
        self.client, self.async_client = self._initialize_clients()
